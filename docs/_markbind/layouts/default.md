...
<header sticky>
  <navbar type="dark">
    ...
    <li><a href="https://github.com/AY2324S2-CS2103T-F11-4/tp" target="_blank" class="nav-link"><md>:fab-github:</md></a>
    </li>
    <li slot="right">
...
* [User Guide]({{ baseUrl }}/UserGuide.html) :expanded:
  ...
  * [Using This User Guide]({{ baseUrl }}/UserGuide.html#using-this-user-guide)
