...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullTelegram_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ROOMNUMBER,
                null, VALID_BIRTHDAY, VALID_DORMTAG, VALID_FREETIMETAGS);
    ...
    public void toModelType_nullBirthday_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ROOMNUMBER,
                VALID_TELEGRAM, null, VALID_DORMTAG, VALID_FREETIMETAGS);
    ...
    @Test
    public void toModelType_nullDormTag_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ROOMNUMBER,
                VALID_TELEGRAM, VALID_BIRTHDAY, null, VALID_FREETIMETAGS);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT, DormTag.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
