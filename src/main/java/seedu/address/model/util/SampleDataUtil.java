    ...
    public static Person[] getSamplePersons() {
        ...
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    new RoomNumber("21-06-40 " + date1.toString(), true), new Telegram("alexYeoh"),
                    new Birthday("03/02/2000"), new DormTag("PGPR"), getTagSet("Tue:0700-2100")),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    new RoomNumber("21-07-18 " + date1.toString(), true), new Telegram("berniceYu"),
                    new Birthday("21/02/1999"), new DormTag("PGPR"), getTagSet("Tue:0700-2100")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                    new RoomNumber("21-11-04 " + date2.toString(), true), new Telegram("charlotteOliveiro"),
                    new Birthday("02/04/2000"), new DormTag("UTR"), getTagSet("Tue:0700-2100")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    new RoomNumber("21-16-43 " + date2.toString(), true), new Telegram("davidLi"),
                    new Birthday("21/04/1998"), new DormTag("UTR"), getTagSet("Tue:0700-2100")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                    new RoomNumber("21-17-35 " + date3.toString(), true), new Telegram("irfanIbrahim"),
                    new Birthday("16/04/1993"), new DormTag("UTR"), getTagSet("Tue:0700-2100")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                    new RoomNumber("21-11-31 " + date3.toString(), true), new Telegram("royBalakrishnan"),
